...
function template_header($title)
{
    ...
    <link href="jostyle.css?v=2" rel="stylesheet" type="text/css">
    <link href="assets/css/home.css?v=2" rel="stylesheet" type="text/css">
    EOT;
}
function template_header_other()
{
    echo <<<EOT
    <link href="assets/css/painting.css?v=2" rel="stylesheet" type="text/css">
    <link href="assets/css/science.css?v=2" rel="stylesheet" type="text/css">
EOT;
}
